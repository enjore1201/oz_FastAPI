...
@edgedb_router.post("", description="meeting 을 생성")
...
@edgedb_router.get("/{meeting_url_code}", description="meeting 을 조희합니다")
async def api_get_meeting_edgedb(meeting_url_code: str) -> GetMeetingResponse:
    return GetMeetingResponse(url_code="abc")


@mysql_router.get("/{meeting_url_code}", description="meeting 을 조희합니다")
